...
.btn-buy{
    width:100%;padding:.6rem;background:var(--cherry);color:white;
...
.btn-wish-lg{
    width:100%;padding:.55rem;background:#fff0f2;color:var(--cherry);
    border:1.5px solid #ffd0d8;border-radius:10px;font-size:.85rem;font-weight:700;
