...
<div id="app">
    <aside class="adm-sidebar">
        ...
        <nav class="adm-nav">
            ...
            <a href="#" class="adm-nav-item" data-tip="Kuponat">
                <i class="bi bi-tag-fill"></i>
            </a>
            <a href="#" class="adm-nav-item" data-tip="Pagesat">
                <i class="bi bi-credit-card-2-front-fill"></i>
            </a>
            <a href="#" class="adm-nav-item" data-tip="Vlerësimet">
                <i class="bi bi-star-fill"></i>
            </a>
            <a href="#" class="adm-nav-item" data-tip="Dërgesat">
                <i class="bi bi-truck-front-fill"></i>
            </a>
            <a href="#" class="adm-nav-item" data-tip="Adresat">
                <i class="bi bi-geo-alt-fill"></i>
            </a>
            <a href="#" class="adm-nav-item" data-tip="Lista Dëshirave">
    ...
    <div class="adm-main">
        <header class="adm-topbar">
            ...
            <div class="d-flex align-items-center gap-3">
                <span class="text-muted" style="font-size:0.78rem;">{{ now()->format('d M Y') }}</span>
                <button class="btn btn-sm btn-light rounded-circle p-2 border-0">
                    <i class="bi bi-bell" style="font-size:0.95rem;"></i>
                </button>
                <div class="d-flex align-items-center gap-2">
                    <div class="rounded-circle d-flex align-items-center justify-content-center text-white fw-bold"
                         style="width:36px;height:36px;background:var(--cherry);font-size:0.85rem;flex-shrink:0;">
                        {{ strtoupper(substr(Auth::user()->name, 0, 1)) }}
                    </div>
                    <div class="d-none d-sm-block">
                        <div class="fw-semibold" style="font-size:0.83rem;line-height:1.2;">{{ Auth::user()->name }}</div>
